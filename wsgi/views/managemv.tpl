                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        % if dcdc.mvdict[key]['status'] == 'stopped':
                            <a href="/node/power/on/{{node['node']}}/{{dcdc.mvdict[key]['vmid']}}">
