...
<form action='/createdatacenter' method="post">
        ...
        <fieldset>
            ...
            % ossytems = [{ 'win8' : 'Windows 8/10/2012' }, { 'win7' : 'Windows 7' }, { 'l24' : 'Linux 2.4' }, { 'l26' : 'Linux 2.6'}, { 'other' : 'Sin especificar' }]
            % for ossys in ossytems:
            %       key = ossys.keys()[0]
                <input type="radio" name="ossytem" value="{{key}}">{{ossys[key]}}</input>
            % end
        </fieldset>
</form>
